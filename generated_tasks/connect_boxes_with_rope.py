...
class ConnectBoxesWithRope(Task):
    ...
    def reset(self, env):
        ...
        objects, targets, matches = self.make_ropes(env, corners=(
        corner_poses[0][0], corner_poses[1][0]), n_parts=n_parts)
        self.add_goal(objs=objects, matches=matches, targ_poses=targets, replace=False,
                      ...
                      language_goal=self.lang_template.format(color1=target_colors[0],

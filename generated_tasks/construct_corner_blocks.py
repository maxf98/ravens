...
class ConstructCornerBlocks(Task):
    ...
    def reset(self, env):
        ...
        self.add_goal(objs=blocks[:2], matches=np.ones((2, 2)), targ_poses=targs[:2],
                      replace=False,
        ...
        self.add_goal(objs=blocks[2:3], matches=np.ones((1, 1)), targ_poses=targs[2:3],
                      replace=False,
        ...
        self.add_goal(objs=blocks[3:], matches=np.ones((1, 1)), targ_poses=targs[3:],
                      replace=False,

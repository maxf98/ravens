...
class ColorOrderedContainerArrangement(Task):
    ...
    def reset(self, env):
        ...
        for color in color_order:
            ...
            container_id = env.add_object(container_urdf, container_pose,
            ...
            self.add_goal(objs=[block_id], matches=np.ones((1, 1)), targ_poses=[container_pose],
                          replace=False,
        ...
        self.add_goal(objs=containers, matches=np.eye(len(color_order)),
                      targ_poses=container_poses, replace=False,

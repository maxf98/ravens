...
class BuildBridge(Task):
    ...
    def __init__(self):
        super().__init__()
        self.max_steps = 20
        self.lang_template = "build a bridge in the zone using four yellow blocks and one long blue block"
    ...
    def reset(self, env):
        ...
        for idx in range(4):
            ...
            base_block_id = env.add_object(base_block_urdf, base_block_pose,
        ...
        body_block_id = env.add_object(body_block_urdf, body_block_pose,
